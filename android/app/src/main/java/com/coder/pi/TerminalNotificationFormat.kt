...
object TerminalNotificationFormat {
    ...
    fun groupKey(
        ...
        fallback: String,
    ): String = "terminal:${context.terminalId.ifBlank { context.deepLink }.ifBlank { context.workspaceId }.ifBlank { fallback }}"
    ...
    fun progressNotificationId(context: TerminalNotificationContext): Int =
        (
            progressBaseId xor
                context.terminalId
                    .ifBlank { context.deepLink }
                    .ifBlank { context.workspaceId }
                    .hashCode()
        ) and 0x7fffffff
}
