...
- Target-device proof remains blocked: `adb devices -l` only lists `emulator-5554 product:sdk_gphone64_arm64 model:sdk_gphone64_arm64 device:emu64a`; no Pixel 7 Pro or Samsung Tab A9 is attached.
