...
export async function getJjFileContentsForDiff(
  ...
  switch (diffType) {
    ...
    case "branch": {
      throw new Error('Not implemented yet: "branch" case');
    }
    case "last-commit": {
      throw new Error('Not implemented yet: "last-commit" case');
    }
    case "merge-base": {
      throw new Error('Not implemented yet: "merge-base" case');
    }
    case "p4-default": {
      throw new Error('Not implemented yet: "p4-default" case');
    }
    case "staged": {
      throw new Error('Not implemented yet: "staged" case');
    }
    case "uncommitted": {
      throw new Error('Not implemented yet: "uncommitted" case');
    }
    case "unstaged": {
      throw new Error('Not implemented yet: "unstaged" case');
    }
    default:
