...
- Added settings-facing model cache status labels for missing, Git LFS pointer, incomplete, and ready cache states, plus a delete action that removes cached Parakeet files when present.
