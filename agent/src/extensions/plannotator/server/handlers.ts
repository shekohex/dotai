/**
 * Shared request handlers reused across plan, review, and annotate servers. handleImageRequest,
 * handleUploadRequest, handleDraftRequest, handleFavicon
 */
...
import { json, parseBody, send, toWebRequest } from "./helpers.js";
...
export function handleImageRequest(res: Res, url: URL): void {
  ...
  if (base !== null && !imagePath.startsWith("/") && tryServePath(resolvePath(base, imagePath))) {
    return;
  }
