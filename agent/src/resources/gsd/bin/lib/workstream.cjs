 ...
 *
 * Workstreams enable parallel milestones by scoping ROADMAP.md, STATE.md, REQUIREMENTS.md, and
 * phases/ into .planning/workstreams/{name}/ directories.
 *
 * When no workstreams/ directory exists, GSD operates in "flat mode" with everything at .planning/
 * — backward compatible with pre-workstream installs.
 */
...
/**
 * Migrate flat .planning/ layout to workstream mode. Moves per-workstream files (ROADMAP.md,
 * STATE.md, REQUIREMENTS.md, phases/) into .planning/workstreams/{name}/. Shared files (PROJECT.md,
 * config.json, milestones/, research/, codebase/, todos/) stay in place.
 */
...
/**
 * Return other workstreams that are NOT complete. Used to detect whether the milestone has active
 * parallel work when a workstream finishes its last phase.
 */
