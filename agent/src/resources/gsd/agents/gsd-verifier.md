...
<required_reading>
@{{GSD_BUNDLE_DIR}}/references/verification-overrides.md
...
@{{GSD_BUNDLE_DIR}}/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@{{GSD_BUNDLE_DIR}}/references/few-shot-examples/verifier.md
