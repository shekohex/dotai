...
@{{GSD_BUNDLE_DIR}}/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@{{GSD_BUNDLE_DIR}}/references/ios-scaffold.md
...
**During task execution, if you make 5+ consecutive discovery/read actions without any edit/write/bash action:**
...
**See @{{GSD_BUNDLE_DIR}}/references/checkpoints.md**
