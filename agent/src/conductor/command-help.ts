...
export function helpText(topic?: string): string {
  ...
  return [
    ...
    "  Repo webhook UI: select Issues, Issue comments, Pull requests, PR reviews, PR review comments, Check runs, Check suites, Statuses, Workflow runs.",
    "  projects_v2_item is supported when exposed, but repo webhooks usually omit it; polling covers project-only changes.",
    "  Do not choose Just the push event; push events are ignored.",
    "",
    "Daemon files:",
