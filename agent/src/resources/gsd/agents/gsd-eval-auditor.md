...
<required_reading>
Read `{{GSD_BUNDLE_DIR}}/references/ai-evals.md` before auditing. This is your scoring framework.
</required_reading>
...
grep -r "guardrail\|safety*check\|moderation\|content_filter" \
 --include="*.py" --include="\_.ts" --include="\*.js" -l 2>/dev/null | head -20
