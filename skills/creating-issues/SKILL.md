...
description: Create GitHub issues with gh in the user's concise style. Use when asked to file an issue or bug report.
---
...
Use [references/project-placement.md](references/project-placement.md) when recent similar issues establish project or milestone usage. Populate only justified values; leave ambiguous fields unset and report them. A project permission failure must not hide a successfully created issue URL.
