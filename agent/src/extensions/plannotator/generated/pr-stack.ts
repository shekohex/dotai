...
import type { DiffResult, ReviewGitRuntime } from "./review-core.js";
import type {
  PRDiffScopeOption,
  PRMetadata,
  PRStackInfo,
...
/**
 * Fetch and checkout a PR/MR head in a local worktree. Returns true if the checkout succeeded,
 * false otherwise.
 */
...
/**
 * Build a minimal stack tree from existing metadata (no API calls). Used as a fallback when the
 * full stack tree hasn't loaded yet.
 */
