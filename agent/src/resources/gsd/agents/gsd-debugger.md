...
<required_reading>
@{{GSD_BUNDLE_DIR}}/references/common-bug-patterns.md
</required_reading>
...
@{{GSD_BUNDLE_DIR}}/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = {{GSD_BUNDLE_DIR}}
                  → writes to {{GSD_BUNDLE_DIR}}/hooks/
...
@{{GSD_BUNDLE_DIR}}/references/thinking-models-debug.md
...
- Read @{{GSD_BUNDLE_DIR}}/references/common-bug-patterns.md
