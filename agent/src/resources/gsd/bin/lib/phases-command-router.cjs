...
/**
 * Manifest-backed phases subcommand router. Keeps gsd-tools.cjs thin while preserving current CJS
 * semantics: - list - clear
 *
 * Note: `archive` is currently SDK-only (`phases.archive` handler in SDK query registry). CJS
 * `gsd-tools phases` intentionally supports list/clear only.
 */
