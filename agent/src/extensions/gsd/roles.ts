...
const registry: Record<GsdRole, GsdRoleConfig> = {
  planner: {
    ...
    builtInModeSpec: {
      ...
      modelId: "gpt-5.5",
      thinkingLevel: "xhigh",
      tools: ["read", "grep", "find", "bash", "write", "websearch", "interview"],
  ...
  verifier: {
    ...
    builtInModeSpec: {
      ...
      modelId: "gpt-5.5",
      thinkingLevel: "medium",
      tools: ["read", "grep", "find", "bash", "write", "websearch"],
      systemPromptMode: "replace",
      autoExit: true,
    },
  },
  ...
  debugger: {
    ...
    builtInModeSpec: {
      ...
      modelId: "gpt-5.5",
      thinkingLevel: "low",
      tools: ["read", "grep", "find", "bash", "edit", "write", "websearch", "interview", "execute"],
      systemPromptMode: "replace",
      autoExit: true,
    },
  },
