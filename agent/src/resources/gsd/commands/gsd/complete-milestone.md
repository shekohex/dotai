...
- `--text` — Use plain-text confirmations instead of structured question forms.
...
- @{{GSD_BUNDLE_DIR}}/workflows/complete-milestone.md (main workflow)
- @{{GSD_BUNDLE_DIR}}/templates/milestone-archive.md (archive template)
  </execution_context>
...
7. **Commit and tag:**
   - Stage: local milestone archive files, PROJECT.md, ROADMAP.md, STATE.md
