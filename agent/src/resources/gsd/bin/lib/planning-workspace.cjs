 ...
 *
 * This module owns the planning workspace seam: - planningDir/planningRoot/planningPaths - active
 * workstream pointer policy (session-scoped > shared) - pointer storage adapters
