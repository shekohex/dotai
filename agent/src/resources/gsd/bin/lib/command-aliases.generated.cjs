...
/**
 * GENERATED FILE — state._, verify._, init._, phase._, phases._, validate._, and roadmap.*
 * alias/subcommand metadata for CJS routing. Source:
 * sdk/src/query/command-manifest.{state,verify,init,phase,phases,validate,roadmap}.ts
 */
...
const STATE_COMMAND_ALIASES = [
  ...
  { canonical: "state.prune", aliases: ["state prune"], subcommand: "prune", mutation: true },
  {
    ...
    aliases: ["state milestone-switch"],
    subcommand: "milestone-switch",
    mutation: true,
  },
  {
    canonical: "state.add-roadmap-evolution",
    aliases: ["state add-roadmap-evolution"],
...
const VERIFY_COMMAND_ALIASES = [
  {
    ...
    aliases: ["verify plan-structure"],
    subcommand: "plan-structure",
    mutation: false,
  },
  {
    canonical: "verify.phase-completeness",
    aliases: ["verify phase-completeness"],
...
const PHASE_COMMAND_ALIASES = [
  ...
  { canonical: "phase.remove", aliases: ["phase remove"], subcommand: "remove", mutation: true },
  {
    ...
    aliases: ["phase complete"],
    subcommand: "complete",
    mutation: true,
  },
  {
    canonical: "phase.scaffold",
    aliases: ["phase scaffold"],
    subcommand: "scaffold",
    mutation: true,
  },
];
...
const VALIDATE_COMMAND_ALIASES = [
  {
    ...
    aliases: ["validate consistency"],
    subcommand: "consistency",
    mutation: false,
  },
  {
    canonical: "validate.health",
    aliases: ["validate health"],
    subcommand: "health",
    mutation: false,
  },
  {
    canonical: "validate.agents",
    aliases: ["validate agents"],
    subcommand: "agents",
    mutation: false,
  },
  {
    canonical: "validate.context",
    aliases: ["validate context"],
    subcommand: "context",
    mutation: false,
  },
];
