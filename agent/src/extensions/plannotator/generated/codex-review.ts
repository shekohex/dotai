 ...
 *
 * Encapsulates all Codex-specific logic for the AI review agent integration. The review server
 * (review.ts) calls into this module via the agent-jobs callbacks.
 */
