 ...
 * Draft Storage
 *
 * Persists annotation drafts to ~/.plannotator/drafts/ so they survive server crashes. Each draft
 * is keyed by a content hash of the plan/diff it was created against.
 *
...
/**
 * Generate a stable key from content using truncated SHA-256. Same content always produces the same
