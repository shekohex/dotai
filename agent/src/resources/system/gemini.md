...
1. **Understand:** Think about the user's request and the relevant codebase context. Use 'find' for file/path discovery and 'grep' for content search (in parallel if independent) to understand file structures, existing code patterns, and conventions. Use 'read' to understand context and validate any assumptions you may have.
