 ...
 *
 * Handles: - SSH: git@github.com:org/repo.git - HTTPS: https://github.com/org/repo.git - SSH with
 * port: ssh://git@github.com:22/org/repo.git - GitLab subgroups:
...
/**
 * Parse the host from a git remote URL. Returns null when the shape doesn't match a known remote
 * form. Used to identify the forge (github.com, gitlab.com, self-hosted) so inline mention / issue
