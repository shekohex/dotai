 ...
 *
 * Shared between the CLI (single HTML file / URL) and the server (on-demand conversion for HTML
 ...
 *
 * Uses a module-level TurndownService singleton (stateless, safe to reuse). GFM tables,
 * strikethrough, and task lists are supported via turndown-plugin-gfm.
 */
