...
Run `/plannotator review` to open your current git changes in code review UI. Annotate specific lines, switch between diff views (uncommitted, staged, last commit, branch), and submit feedback that gets sent to agent.
...
Run `/plannotator annotate <file.md>` to open any markdown file in annotation UI. Useful for reviewing documentation or design specs with agent.

### Annotate last message

Run `/plannotator last` to annotate agent's most recent response. Message opens in annotation UI where you can highlight text, add comments, and send structured feedback back to agent.
...
| Command                        | Description                                                                                 |
| ------------------------------ | ------------------------------------------------------------------------------------------- |
| `/plannotator`                 | Toggle plan mode. Agent writes markdown plan file in working directory and submits its path |
...
| `/plannotator archive`         | Open saved plan and decision archive                                                        |
...
Extension manages state machine: **idle** → **planning** → **executing** → **idle**.

During **planning**:

- All tools from other extensions remain available
- Bash remains available for discovery commands
- Writes and edits restricted to markdown files inside working directory
